...
int Core::inputValidation(int input)
{
...
int Core::bigInputValidation(int input) 
{
	while (input < 1)
	{
		cout << "Invalid input. Try again " << endl;
